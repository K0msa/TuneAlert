...
public final class Song {
     ...
     * @throws IllegalArgumentException เมื่อ title, artist ห้ามเป็น null หรือ สตริงว่าง 
     *                                  tags เป็น null, สมาชิกใน tags เป็น null, สตริงว่าง 
     */
    ...
    public boolean equals(Object o)
    {
        ...
        if(!(o instanceof Song)) return false; //instanceof เช็คว่าเป็น Class เดียวกันไหม\

        Song r = (Song) o;
        return r.title.equals(title) && r.artist.equals(artist) && r.tags.equals(tags);
    }
